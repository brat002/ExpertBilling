...
Важным параметром является переменная isd_addonservices - здесь через запятую указаны id подключаемых услуг. Если в списке 1 элемент - запятая за ним обязательна, а лучше ставить её
