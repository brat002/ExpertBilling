...
(disabled is NULL and ack=False and datetime>now()-interval '60 seconds' ) or (disabled is not null and disabled>now()-interval '5 minutes'))) ORDER BY RANDOM() LIMIT 1);
