...
(disabled is NULL and ack=False and datetime>now()-(acct_interval*3 || ' seconds')::INTERVAL) or (disabled is not null and disabled>now()-interval '5 minutes'))) ORDER BY RANDOM() LIMIT 1);
