...
class DefaultSpeedData(tuple):
    'DefaultSpeedData(max_tx, max_rx, burst_tx, burst_rx, burst_treshold_tx, burst_treshold_rx,  burst_time_tx, burst_time_rx, min_tx, min_rx,  priority, tarif_id)' 
    ...
    def __repr__(self):
        return 'DefaultSpeedData(max_tx=%r, max_rx=%r, burst_tx=%r, burst_rx=%r, burst_treshold_tx=%r, burst_treshold_rx=%r,  burst_time_tx=%r, burst_time_rx=%r, min_tx=%r, min_rx=%r,  priority=%r, min_limit=%r, tarif_id=%r)' % self 
