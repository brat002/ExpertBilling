...
class AccountData(tuple):
    ...
    def __new__(cls, account_id, username, ipn_mac_address, time_access_service_id, password, nas_id, vpn_ip_address, tarif_id, access_type, account_status, balance_blocked, ballance, disabled_by_limit, vpn_speed, tarif_active, allow_vpn_null, allow_vpn_block, ipn_ip_address, ipn_speed, assign_dhcp_null, assign_dhcp_block, associate_pptp_ipn_ip, associate_pppoe_mac, radius_traffic_transmit_service_id, vpn_ippool_id, vpn_guest_ippool_id):
