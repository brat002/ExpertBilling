...
class AccountData(tuple):
    ...
    def _asdict(t):
        ...
        return {'account_id': t[0], 'username': t[1], 'ipn_mac_address': t[2], 'time_access_service_id': t[3], 'password': t[4], 'nas_id': t[5], 'vpn_ip_address': t[6], 'tarif_id': t[7], 'access_type': t[8], 'account_status': t[9], 'balance_blocked': t[10], 'ballance': t[11], 'disabled_by_limit': t[12], 'vpn_speed': t[13], 'tariff_active': t[14], 'allow_vpn_null': t[15], 'allow_vpn_block': t[16], 'ipn_ip_address': t[17], 'ipn_speed': t[18], 'assign_dhcp_null': t[19], 'assign_dhcp_block': t[20], 'associate_pptp_ipn_ip': t[21], 'associate_pppoe_mac':t[22], 'radius_traffic_transmit_service_id':t[23], 'vpn_ippool_id':t[24], 'vpn_guest_ippool_id':t[25]} 
