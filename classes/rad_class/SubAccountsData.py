...
class SubAccountsData(tuple):
    ...
    ipn_speed = property(itemgetter(20))
    vlan = property(itemgetter(21))
    vpn_ipv6_ip_address = property(itemgetter(22))
    ipv4_vpn_pool_id = property(itemgetter(23))
    sessionscount = property(itemgetter(24))
