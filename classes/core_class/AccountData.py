...
class AccountData(list):
    ...
    def _make(cls, iterable):
        ...
        if len(result) != 41:
            result.extend([None for i in xrange(41 - len(result))])
        return result 
