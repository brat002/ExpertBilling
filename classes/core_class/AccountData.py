...
class AccountData(list):
    ...
    allow_ipn_with_null = property(itemgetter(38), lambda self_, value_: setitem(self_, 38, value_))
    allow_ipn_with_minus = property(itemgetter(39), lambda self_, value_: setitem(self_, 39, value_))
    allow_ipn_with_block = property(itemgetter(40), lambda self_, value_: setitem(self_, 40, value_))
    radius_traffic_transmit_service_id = property(itemgetter(41), lambda self_, value_: setitem(self_, 41, value_))
    userblock_max_days = property(itemgetter(41), lambda self_, value_: setitem(self_, 42, value_))
