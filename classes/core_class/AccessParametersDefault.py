...
class AccessParametersDefault(tuple):
    'AccessParametersDefault(max_limit, burst_limit, burst_treshold, burst_time, priority, min_limit, tarif_id)' 
    ...
    def __repr__(self):
        return 'AccessParametersDefault(max_limit=%r, burst_limit=%r, burst_treshold=%r, burst_time=%r, priority=%r, min_limit=%r, tarif_id=%r)' % self 
