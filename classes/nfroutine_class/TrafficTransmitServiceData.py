...
class TrafficTransmitServiceData(tuple):
    'TrafficTransmitServiceData(id, reset_traffic, cash_method, period_check)' 
    ...
    def _make(cls, iterable, new=tuple.__new__, len=len):
        'Make a new TrafficTransmitServiceData object from a sequence or iterable'
    ...
    def __repr__(self):
        return 'TrafficTransmitServiceData(id=%r, reset_traffic=%r, cash_method=%r, period_check=%r)' % self 
    ...
    def _replace(self, **kwds):
        'Return a new TrafficTransmitServiceData object replacing specified fields with new values'
