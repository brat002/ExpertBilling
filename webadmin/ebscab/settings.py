...
DATABASE_NAME = 'ebs_alt'             # Or path to database file if using sqlite3.
...
ALLOW_WEBMONEY = True
ALLOW_QIWI = True
WEBCAB_LOG = './log/webcab_log'#/opt/ebs/web/ebscab/log/webcab_log'
...
COMPRESS_JS = {
    ...
    'scripts_js_ux': {
        ...
        "ext/ebs/plugins/GroupSummary.js",
