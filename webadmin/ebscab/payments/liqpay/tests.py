...
class SimpleTest(TestCase):
    ...
    def test_confirm(self):
        ...
        TransactionType.objects.create(
            name='EasyPay', internal_name='payments.easypay')
...
</Request>""" % bs.response.paymentid,
                          content_type='text/xml')

        print 'TRANSACTION=', Transaction.objects.get(
            type__internal_name='payments.easypay', bill='1')
...
<PaymentId>%s</PaymentId>
        ...
        self.assertEqual(Transaction.objects
                         .filter(type__internal_name='payments.easypay',
                                 bill='1')
                         .count(), 0)
