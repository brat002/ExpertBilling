...
class SmsMessage(object):
    ...
    def __init__(self, body, from_phone=None, to=None, flash=False,
                 connection=None):
        """
        ...
        self.from_phone = from_phone or getattr(settings,
                                                'SENDSMS_DEFAULT_FROM_PHONE',
                                                '')
        self.body = body
        self.flash = flash
    ...
    def get_connection(self, fail_silently=False):
        from sendsms.api import get_connection  # avoid cyclic imports
