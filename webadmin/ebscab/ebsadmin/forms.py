...
'distnassestraffic': {'name':_(u'Распределение трафика по серверам доступа'), 'tabs':['nassesTab', ], 'type': 'pie'},
'distraccountstoptraffic': {'name':_(u'ТОП 10 по потреблению трафика '), 'tabs':[ 'groupsTab'], 'type': 'pie'},
'accountsincrease': {'name':_(u'Прирост абонентской базы '),  'yname':_(u'Количество'), 'units': u'Аккаунтов', 'tabs':[], 'type': 'spline'},
