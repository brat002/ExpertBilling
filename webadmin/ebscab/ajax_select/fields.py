...
class AutoCompleteSelectMultipleField(forms.fields.CharField):
    ...
    def __init__(self, channel, attrs={}, placeholder='', *args, **kwargs):
        self.channel = channel
        ...
        if not (help_text is None):
            try:
                ...
                # monkey patch the django default help text to the ajax selects
                # default help text
        ...
        kwargs['widget'] = AutoCompleteSelectMultipleWidget(
            channel=channel, help_text=help_text, show_help_text=show_help_text, attrs=attrs, placeholder=placeholder)
...
class AutoCompleteField(forms.CharField):
    ...
    def __init__(self, channel, *args, **kwargs):
        ...
        widget_kwargs = dict(help_text=kwargs.get(
...
def bootstrap():
    ...
    if inlines == 'inline':
        ...
        f = open(os.path.join(
            directory, "static", 'ajax_select', "css", "ajax_select.css"))
        css = f.read()
        f = open(os.path.join(
            directory, "static", 'ajax_select', "js", "ajax_select.js"))
        js = f.read()
        b['inline'] = mark_safe(
