...
class Account(DynamicModel):
    ...
    #NOTE: baLance
    ballance=models.DecimalField(_(u'Баланс'), blank=True, default=0,decimal_places=10,max_digits=20)
...
class Switch(models.Model):
    ...
    snmp_version = models.CharField(max_length=10, choices=((1, _(u"v1"),),(2, _(u"v2c"),)), verbose_name=_(u"Версия SNMP"), blank=True, default='v1')#version
