...
class RadiusAttrs(models.Model):
    ...
    value = models.CharField(max_length = 255)
        class x8021(models.Model):    account = models.ForeignKey(Account, blank = True)    nas = models.ForeignKey(Nas)    port = models.SmallIntegerField()    typeauth = models.CharField(verbose_name=u"Способ авторизации", choices=AUTH_TYPES, max_length=32)    vlan_accept = models.IntegerField()    vlan_reject = models.IntegerField()    simpleauth = models.BooleanField()    