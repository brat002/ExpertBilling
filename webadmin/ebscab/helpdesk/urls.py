...
urlpatterns = patterns('helpdesk.views',
                       ...
                       (r'^tickets/history/$', 'tickets_history'),
                       (r'^ticket/user/info/$', 'ticket_user_info'),
                       (r'^ticket/accept/$', 'ticket_accept'),
                       (r'^filter/form/$', 'filter_form'),
                       (r'^ticket/(?P<ticket_id>\d+)/comments/$', 'ticket_show_comments'),
                      )
