...
COLOR_TICKETS = (
                 ...
                 (HOLD, u"",),# - Тикет назначен, идёт работа, тикет невозможно переназначить без смены статуса
                 (CLOSED, u"",), # - Тикет закрыт - может быть архивирован
                 (RESOLVED, u"#9E7FB0",), # - Тикет закрыт - может быть архивирован                
                 (REOPENED, u"",), # - Тикет закрыт - может быть архивирован                
