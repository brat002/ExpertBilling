...
class Menu(object):
    ...
    def add(self, reverse_conf, verbose_name, attrs=None):
        ...
        self.items.append({
            ...
            'url': (reverse_conf.view_name.startswith("/") and
                    reverse_conf.view_name or
                    reverse(reverse_conf.view_name,
                            args=reverse_conf.args,
                            kwargs=reverse_conf.kwargs)),
