...
class Account(models.Model):
    ...
    passport_given = models.CharField(max_length=64)
    phone_h = models.CharField(max_length=64)
    phone_m = models.CharField(max_length=64)
    contactperson_phone = models.CharField(max_length=64)
    comment = models.TextField()
    row = models.CharField(max_length=6)
    elevator_direction = models.CharField(max_length=128)
    contactperson = models.CharField(max_length=256)
    passport_date = models.CharField(max_length=128)
    contract = models.TextField()
    systemuser = models.ForeignKey('SystemUser',blank=True,null=True)
    last_balance_null = models.DateTimeField()
    entrance_code = models.CharField(max_length=256)
    private_passport_number = models.CharField(max_length=128)
...
class SubAccount(models.Model):
    ...
    ipn_mac_address = models.CharField(max_length=12)
    nas = models.ForeignKey(Nas)
