        ...
        if form.is_valid():
            try:
                ...
                if user.password == form.cleaned_data['password']:
                    ...
                    return JsonResponse({'success': False, 'errors': { 'reason': 'Login failed. Try again.' }})
            except :
                return JsonResponse({'success': False, 'errors': { 'reason': 'Login Error. Call administrator.' }})
        else:
           
            return JsonResponse({'success': False, 'errors': { 'reason': 'Login not valid. Call administrator.' }})
    else:
      
        return JsonResponse({'success': False, 'errors': { 'reason': 'Request does not POST. Call administrator.' }})  
