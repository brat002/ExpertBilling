...
class Nas(models.Model):
    ...
    name = models.CharField(verbose_name=u'Имя сервера доступа', max_length=255, unique=True)
    identify = models.CharField(verbose_name=u'Идентификатор сервера доступа', help_text=u"Используется дли идентификации сервера доступа. Смотрите настройки /system identity print", max_length=255, unique=False)
