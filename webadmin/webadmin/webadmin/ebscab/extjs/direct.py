...
remote_provider = ExtRemotingProvider(namespace='EBS', url='/extjs/remoting/router/')
polling_provider = ExtPollingProvider(url='/extjs/polling/router/', event='some-event')
