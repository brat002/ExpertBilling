...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
    {
		...
		protected Font hoverContentFont = new Font("Arial",12,FontStyle.Underline,GraphicsUnit.Pixel);
		...
		public event NewsMessageEventHandler ContentClick = null;
		#endregion
        ...
        /// <summary>
	    /// Get the current count of popup windows
	    /// </summary>
	    public ushort NotifyWindowCount
	    {
	        get
	        {
	            return _notifyWindowCount;
	        }
	    }
		...
		public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
		{
			...
			switch (taskbarState)
			{
				case TaskbarStates.hidden:
                    ...
                    // Width -17; Bottom-1;
                    int _bottomBound = WorkAreaRectangle.Bottom - 1;
                    if ((WorkAreaRectangle.Bottom - 1) - BackgroundBitmap.Height * (NotifyWindowCount - 1) >= BackgroundBitmap.Height )
                    {
                        _bottomBound = (WorkAreaRectangle.Bottom - 1) - BackgroundBitmap.Height*(NotifyWindowCount - 1);
                    }
                    
					SetBounds(WorkAreaRectangle.Right-BackgroundBitmap.Width, _bottomBound, BackgroundBitmap.Width, 0);
        ...
        /// <summary>
        ///  Show pop-up window with default params and some Text
        /// </summary>
        /// <param name="text">Content text</param>
        /// <param name="title">Title text</param>
        /// <returns>Nothing</returns>
        public void ShowNotifyMessage(String title, String text)
        {
            this.SetBackgroundBitmap(new Bitmap(ebsmon.Properties.Resources.popUp_skin), Color.FromArgb(255, 0, 255));
            this.SetCloseBitmap(new Bitmap(ebsmon.Properties.Resources.close), Color.FromArgb(255, 0, 255), new Point(150, 10));
            this.TitleRectangle = new Rectangle(40, 9, 70, 25);
            this.ContentRectangle = new Rectangle(8, 41, 133, 68);
            this.CloseClick += new EventHandler(eCloseClick);
            ...
            this.Show(title, text, 500, 3000, 500);
        }
		...
		protected override void OnMouseUp(MouseEventArgs mea)
		{
			...
			else if (bIsMouseOverContent)
			{
				if (ContentClick != null)
					ContentClick(this, new NewsMessageEventArgs(this.contentText));
			}
		}
        ...
        protected void eCloseClick(object obj, EventArgs ea)
        {
            _notifyWindowCount--;
        }
