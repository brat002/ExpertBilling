            ...
            try:
                ...
                for row in rows:
                    try:
                        ...
                        if acstatus and tp_asInPeriod[tarif_id] and tarif_status:
                ...
                for flow in flows:
                    ...
                    if tts_id:
                        ...
                        for tclass in flow[22]:
                            ...
                            #flow[23] - direction
                            f_direction = flow[23]
                            trafic_cost=self.get_actual_cost(tts_id, tclass, f_direction, octets_summ, stream_date)
                            """
                            ...
                            prepInf =  prepaysCache.get((tts_id, acct[12],tclass))
            ...
            try:
                ...
                for acct in cacheAT:
                    ...
                    if (prepaid_traffic_accrued is None or prepaid_traffic_accrued<period_start) and traffic_transmit_service_id:                          
                        ...
                        cur.execute(
                            """
                            SELECT id, size FROM billservice_prepaidtraffic WHERE traffic_transmit_service_id=%s;
                        ...
                        for prepaid_traffic_id, size in prepais:
                            ...
                            cur.execute(
                                """
                                UPDATE billservice_accountprepaystrafic SET size=size+%s, datetime=%s
