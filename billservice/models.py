...
class SubAccount(models.Model):
    ...
    ipn_added = models.BooleanField(verbose_name=u'Добавлен на NAS')
    ipn_enabled = models.BooleanField(verbose_name=u'Включен на NAS')
    ipn_sleep = models.BooleanField(verbose_name=u'не менять IPN статус')
