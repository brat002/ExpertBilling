...
class EmailMessage(object):
    ...
    def message(self):
        ...
        msg = SafeMIMEText(smart_str(self.body, DEFAULT_CHARSET),
    ...
    def _create_attachment(self, filename, content, mimetype=None):
        ...
        if basetype == 'text':
            attachment = SafeMIMEText(smart_str(content,
                DEFAULT_CHARSET), subtype, DEFAULT_CHARSET)
        else:
...
def send_mail(subject, message, from_email, recipient_list,
              fail_silently=False, auth_user=None, auth_password=None, host=None, port=25, use_tls=None):
    """
    ...
    connection = SMTPConnection(username=auth_user, password=auth_password,
                                fail_silently=fail_silently, host=host, port=port, use_tls=use_tls)
