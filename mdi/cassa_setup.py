...
setup(windows=[{"script":'cassa.py',"icon_resources": [(1, "cassa_icon.ico")]}], options={"py2exe" : {"dist_dir": "cassa", "includes" : ["pkg_resources", "Crypto", "rpc2", "sip","mako.cache","db","PyQt4.QtNetwork", "PyQt4.QtSql","psycopg2.tz"], "packages": ["sqlite3",]}},
