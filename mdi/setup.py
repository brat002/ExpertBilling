...
setup(windows=[{"script":'mdi.py',"icon_resources": [(1, "icon.ico")]}], options={"py2exe" : {"includes" : ["sip","mako.cache","db","PyQt4.QtNetwork", "PyQt4.QtSql","psycopg2.tz"], "packages": ["sqlite3",]}}, \
