...
setup(windows=[{"script":'ebsadmin.py',"icon_resources": [(1, "icon.ico")]}], options={"py2exe" : {"dist_dir": "EBSAdmin", "includes" : ["sip","mako.cache","db","PyQt4.QtNetwork", "PyQt4.QtSql", "psycopg2.tz", "twisted.web.resource",], "packages": ["win32com", "sqlite3",]}}, \
