...
class SettlementPeriodEbs(ebsTableWindow):
    ...
    def addrow(self, value, x, y, autostart=False):
    ...
    def refresh(self):
        ...
        for period in periods:
            ...
            self.addrow(period.time_start.strftime(self.strftimeFormat), i,3,autostart=period.autostart)
