...
class SwitchMainWindow(QtGui.QMainWindow):
    def __init__(self, parent, connection, model=None):
        ...
        self.gridLayout.addWidget(self.groupBox_option82, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupBox_management, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.groupBox_network_identify, 4, 0, 1, 2)
        ...
        self.comboBox_street.setObjectName(_fromUtf8("comboBox_city_2"))
        ...
        self.comboBox_house.setObjectName(_fromUtf8("comboBox_city_3"))
        ...
        self.label_ports_num = QtGui.QLabel(self.tab)
        self.label_ports_num.setObjectName(_fromUtf8("label_ports_num"))
        self.gridLayout.addWidget(self.label_ports_num, 6, 0, 1, 1)
        self.spinBox_ports_num = QtGui.QSpinBox(self.tab)
        self.spinBox_ports_num.setObjectName(_fromUtf8("spinBox_ports_num"))
        self.gridLayout.addWidget(self.spinBox_ports_num, 6, 1, 1, 1)
        ...
        self.tableWidget.setObjectName(_fromUtf8("tableWidget_switch_ports"))
        ...
        self.setTabOrder(self.lineEdit_comment, self.comboBox_city)
        ...
        self.setTabOrder(self.lineEdit_place, self.comboBox_management_method)
        ...
        self.setTabOrder(self.lineEdit_password, self.lineEdit_ipaddress)
        ...
        self.setTabOrder(self.lineEdit_name, self.groupBox_snmp_support)
        ...
        self.setTabOrder(self.lineEdit_community, self.spinBox_ports_num)
        self.setTabOrder(self.spinBox_ports_num, self.groupBox_option82)
        self.setTabOrder(self.groupBox_option82, self.comboBox_option82_auth_type)
        self.setTabOrder(self.comboBox_option82_auth_type, self.lineEdit_enable_port_command)
    ...
    def accept(self):
        ...
        protected_ports=[]
        broken_ports=[]
        for i in xrange(model.ports_count):
...
class SwitchEbs(ebsTableWindow):
    def __init__(self, parent, connection):
        columns=['#', u'Производитель', u'Название', u'Модель', u'IP', u'Место установки', u"Количество портов"]
