...
class TimePeriodChildEbs(ebsTable_n_TreeWindow):
    ...
    def ebsInterInit(self, initargs):
        ...
        self.connect(self.tableWidget, QtCore.SIGNAL("cellDoubleClicked(int, int)"), self.editPeriod)
        ...
        objDict = {self.treeWidget :["editPeriodAction", "addPeriodAction", "delPeriodAction"], \
                   ...
                   self.toolBar    :["addPeriodAction", "delPeriodAction", "separator", "addConsAction", "delConsAction"]
                  }
