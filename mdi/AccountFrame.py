...
class TarifWindow(QtGui.QMainWindow):
    def __init__(self, connection, model=None, parent=None):
        ...
        self.groupBox_allowuserblock.setChecked(False)
        ...
        self.checkBox_userblock_balance_require = QtGui.QCheckBox(self.groupBox_allowuserblock)
        self.checkBox_userblock_balance_require.setObjectName(_fromUtf8("checkBox_userblock_balance_require"))
        self.gridLayout_10.addWidget(self.checkBox_userblock_balance_require, 1, 0, 1, 2)
    ...
    def retranslateUi(self):
        ...
        self.tarif_name_label.setToolTip(QtGui.QApplication.translate("self", "Уникальное название тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_name_label.setWhatsThis(QtGui.QApplication.translate("self", "Уникальное название тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_name_label.setText(QtGui.QApplication.translate("self", "Название", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_name_edit.setToolTip(QtGui.QApplication.translate("self", "Уникальное название тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_name_edit.setWhatsThis(QtGui.QApplication.translate("self", "Уникальное название тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_groupbox.setToolTip(QtGui.QApplication.translate("self", "Предоставление тарифного плана как пакета на срок расчётного периода", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_groupbox.setWhatsThis(QtGui.QApplication.translate("self", "Предоставление тарифного плана как пакета на срок расчётного периода", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_groupbox.setTitle(QtGui.QApplication.translate("self", "Пакетный тарифный план", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_cost_edit.setToolTip(QtGui.QApplication.translate("self", "Стоимость пакета. Поле не используется для тарификации пакета.", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_cost_edit.setWhatsThis(QtGui.QApplication.translate("self", "Стоимость пакета. Поле не используется для тарификации пакета.", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_cost_label.setToolTip(QtGui.QApplication.translate("self", "Стоимость пакета. Поле не используется для тарификации пакета.", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_cost_label.setWhatsThis(QtGui.QApplication.translate("self", "Стоимость пакета. Поле не используется для тарификации пакета.", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_cost_label.setText(QtGui.QApplication.translate("self", "Стоимость пакета", None, QtGui.QApplication.UnicodeUTF8))
        self.reset_tarif_cost_edit.setToolTip(QtGui.QApplication.translate("self", "В конце расчётного периода будет произведено доснятие неизрасходованных средств до указанной стоимости пакета.", None, QtGui.QApplication.UnicodeUTF8))
        self.reset_tarif_cost_edit.setText(QtGui.QApplication.translate("self", "Производить доснятие суммы до стоимости тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.require_tarif_cost_edit.setToolTip(QtGui.QApplication.translate("self", "В случае, если на начало расчётного периода у абонента не будет указанной стоимости пакета - он будет заблокирован", None, QtGui.QApplication.UnicodeUTF8))
        self.require_tarif_cost_edit.setWhatsThis(QtGui.QApplication.translate("self", "В случае, если на начало расчётного периода у абонента не будет указанной стоимости пакета - он будет заблокирован", None, QtGui.QApplication.UnicodeUTF8))
        self.require_tarif_cost_edit.setText(QtGui.QApplication.translate("self", "Требовать наличия всей суммы в начале расчётного периода", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_name_label.setToolTip(QtGui.QApplication.translate("self", "Расчётный период тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_name_label.setWhatsThis(QtGui.QApplication.translate("self", "Расчётный период тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_name_label.setText(QtGui.QApplication.translate("self", "Расчётный период", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_name_edit.setToolTip(QtGui.QApplication.translate("self", "Расчётный период тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.sp_name_edit.setWhatsThis(QtGui.QApplication.translate("self", "Расчётный период тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.label_contracttemplate.setToolTip(QtGui.QApplication.translate("self", "Шаблон номера договора для создаваемых на данном тарифном плане абонентов.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_contracttemplate.setWhatsThis(QtGui.QApplication.translate("self", "Шаблон номера договора для создаваемых на данном тарифном плане абонентов.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_contracttemplate.setText(QtGui.QApplication.translate("self", "Шаблон номера договора", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_contracttemplate.setToolTip(QtGui.QApplication.translate("self", "Шаблон номера договора для создаваемых на данном тарифном плане абонентов.", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_contracttemplate.setWhatsThis(QtGui.QApplication.translate("self", "Шаблон номера договора для создаваемых на данном тарифном плане абонентов.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_systemgroup.setToolTip(QtGui.QApplication.translate("self", "Настройки видимости тарифного плана для системных пользователей", None, QtGui.QApplication.UnicodeUTF8))
        self.label_systemgroup.setWhatsThis(QtGui.QApplication.translate("self", "Настройки видимости тарифного плана для системных пользователей", None, QtGui.QApplication.UnicodeUTF8))
        self.label_systemgroup.setText(QtGui.QApplication.translate("self", "Видимость для группы", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_system_group.setToolTip(QtGui.QApplication.translate("self", "Настройки видимости тарифного плана для системных пользователей", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_system_group.setWhatsThis(QtGui.QApplication.translate("self", "Настройки видимости тарифного плана для системных пользователей", None, QtGui.QApplication.UnicodeUTF8))
        self.access_time_label.setToolTip(QtGui.QApplication.translate("self", "Разрешённое время доступа/авторизации для абонентов", None, QtGui.QApplication.UnicodeUTF8))
        self.access_time_label.setWhatsThis(QtGui.QApplication.translate("self", "Разрешённое время доступа/авторизации для абонентов", None, QtGui.QApplication.UnicodeUTF8))
        self.access_time_label.setText(QtGui.QApplication.translate("self", "Время доступа", None, QtGui.QApplication.UnicodeUTF8))
        self.access_time_edit.setToolTip(QtGui.QApplication.translate("self", "Разрешённое время доступа/авторизации для абонентов", None, QtGui.QApplication.UnicodeUTF8))
        self.access_time_edit.setWhatsThis(QtGui.QApplication.translate("self", "Разрешённое время доступа/авторизации для абонентов", None, QtGui.QApplication.UnicodeUTF8))
        self.access_type_label.setToolTip(QtGui.QApplication.translate("self", "Способ доступа абонента", None, QtGui.QApplication.UnicodeUTF8))
        self.access_type_label.setWhatsThis(QtGui.QApplication.translate("self", "Способ доступа абонента", None, QtGui.QApplication.UnicodeUTF8))
        self.access_type_label.setText(QtGui.QApplication.translate("self", "Способ доступа", None, QtGui.QApplication.UnicodeUTF8))
        self.access_type_edit.setToolTip(QtGui.QApplication.translate("self", "Способ доступа абонента", None, QtGui.QApplication.UnicodeUTF8))
        self.access_type_edit.setWhatsThis(QtGui.QApplication.translate("self", "Способ доступа абонента", None, QtGui.QApplication.UnicodeUTF8))
        self.label_vpn_ippool.setToolTip(QtGui.QApplication.translate("self", "IPv4 пул по-умолчанию для динамической выдачи IP адресов клиентам при VPN авторизации.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_vpn_ippool.setWhatsThis(QtGui.QApplication.translate("self", "IPv4 пул по-умолчанию для динамической выдачи IP адресов клиентам при VPN авторизации.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_vpn_ippool.setText(QtGui.QApplication.translate("self", "VPN пул", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_vpn_ippool.setToolTip(QtGui.QApplication.translate("self", "IPv4 пул по-умолчанию для динамической выдачи IP адресов клиентам при VPN авторизации.", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_vpn_ippool.setWhatsThis(QtGui.QApplication.translate("self", "IPv4 пул по-умолчанию для динамической выдачи IP адресов клиентам при VPN авторизации.", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_allowuserblock.setTitle(QtGui.QApplication.translate("self", "Разрешить пользовательскую блокировку", None, QtGui.QApplication.UnicodeUTF8))
        self.label_userblock_cost.setText(QtGui.QApplication.translate("self", "Стоимость активации блокировки", None, QtGui.QApplication.UnicodeUTF8))
        self.label_max_block_days.setText(QtGui.QApplication.translate("self", "Максимальная продолжительность блокировки, дней", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_userblock_balance_require.setText(QtGui.QApplication.translate("self", "Требовать положительного баланса для активации блокировки", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_description_label.setToolTip(QtGui.QApplication.translate("self", "Текстовое описание тарифного плана для печати накладных и работы с договорами", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_description_label.setWhatsThis(QtGui.QApplication.translate("self", "Текстовое описание тарифного плана для печати накладных и работы с договорами", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_description_label.setText(QtGui.QApplication.translate("self", "Описание тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_description_edit.setToolTip(QtGui.QApplication.translate("self", "Текстовое описание тарифного плана для печати накладных и работы с договорами", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_description_edit.setWhatsThis(QtGui.QApplication.translate("self", "Текстовое описание тарифного плана для печати накладных и работы с договорами", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_status_edit.setToolTip(QtGui.QApplication.translate("self", "Признак возможности работы абонента на данном тарифном плане", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_status_edit.setWhatsThis(QtGui.QApplication.translate("self", "Признак возможности работы абонента на данном тарифном плане", None, QtGui.QApplication.UnicodeUTF8))
        self.tarif_status_edit.setText(QtGui.QApplication.translate("self", "Тарифный план активен", None, QtGui.QApplication.UnicodeUTF8))
        self.components_groupBox.setToolTip(QtGui.QApplication.translate("self", "Набор компонентов тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.components_groupBox.setWhatsThis(QtGui.QApplication.translate("self", "Набор компонентов тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.components_groupBox.setTitle(QtGui.QApplication.translate("self", "Набор компонентов", None, QtGui.QApplication.UnicodeUTF8))
        self.transmit_service_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить тарификацию трафика по протоколу NetFlow", None, QtGui.QApplication.UnicodeUTF8))
        self.transmit_service_checkbox.setText(QtGui.QApplication.translate("self", "NetFlow тарификация", None, QtGui.QApplication.UnicodeUTF8))
        self.time_access_service_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить тарификацию времени по RADIUS Accounting", None, QtGui.QApplication.UnicodeUTF8))
        self.time_access_service_checkbox.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить тарификацию времени по RADIUS Accounting", None, QtGui.QApplication.UnicodeUTF8))
        self.time_access_service_checkbox.setText(QtGui.QApplication.translate("self", "Radius время", None, QtGui.QApplication.UnicodeUTF8))
        self.radius_traffic_access_service_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить тарификацию трафика по RADIUS Accounting", None, QtGui.QApplication.UnicodeUTF8))
        self.radius_traffic_access_service_checkbox.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить тарификацию трафика по RADIUS Accounting", None, QtGui.QApplication.UnicodeUTF8))
        self.radius_traffic_access_service_checkbox.setText(QtGui.QApplication.translate("self", "Radius трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.onetime_services_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить первоначальное списание за услуги при подключении абонента на тарифный план.", None, QtGui.QApplication.UnicodeUTF8))
        self.onetime_services_checkbox.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить первоначальное списание за услуги при подключении абонента на тарифный план.", None, QtGui.QApplication.UnicodeUTF8))
        self.onetime_services_checkbox.setText(QtGui.QApplication.translate("self", "Разовые услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.periodical_services_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить тарификацию периодических услуг(Абонентская плата и другие периодические списания)", None, QtGui.QApplication.UnicodeUTF8))
        self.periodical_services_checkbox.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить тарификацию периодических услуг(Абонентская плата и другие периодические списания)", None, QtGui.QApplication.UnicodeUTF8))
        self.periodical_services_checkbox.setText(QtGui.QApplication.translate("self", "Периодические услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.limites_checkbox.setToolTip(QtGui.QApplication.translate("self", "Разрешить использование квот NetFlow трафика.", None, QtGui.QApplication.UnicodeUTF8))
        self.limites_checkbox.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить использование квот NetFlow трафика.", None, QtGui.QApplication.UnicodeUTF8))
        self.limites_checkbox.setText(QtGui.QApplication.translate("self", "Лимиты трафика", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_addon_services.setToolTip(QtGui.QApplication.translate("self", "Разрешить активацию подключаемых услуг абонентом", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_addon_services.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить активацию подключаемых услуг абонентом", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_addon_services.setText(QtGui.QApplication.translate("self", "Подключаемые услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ip_telephony.setToolTip(QtGui.QApplication.translate("self", "Разрешить тарификацию IP телефонии", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ip_telephony.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить тарификацию IP телефонии", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ip_telephony.setText(QtGui.QApplication.translate("self", "IP телефония", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ipn_actions.setToolTip(QtGui.QApplication.translate("self", "Производить дополнительно IPN действия на сервере доступа для данного способа доступа.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ipn_actions.setWhatsThis(QtGui.QApplication.translate("self", "Производить дополнительно IPN действия на сервере доступа для данного способа доступа.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_ipn_actions.setText(QtGui.QApplication.translate("self", "Производить IPN действия", None, QtGui.QApplication.UnicodeUTF8))
        self.toolButton.setText(QtGui.QApplication.translate("self", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_expresscards_activation.setToolTip(QtGui.QApplication.translate("self", "Разрешить активацию карт экспресс-оплаты на данном тарифном плане.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_expresscards_activation.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить активацию карт экспресс-оплаты на данном тарифном плане.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_expresscards_activation.setText(QtGui.QApplication.translate("self", "Разрешить активацию карт экспресс-оплаты", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_moneytransfer.setToolTip(QtGui.QApplication.translate("self", "Разрешить активацию карт экспресс-оплаты на данном тарифном плане.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_moneytransfer.setWhatsThis(QtGui.QApplication.translate("self", "Разрешить активацию карт экспресс-оплаты на данном тарифном плане.", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_allow_moneytransfer.setText(QtGui.QApplication.translate("self", "Разрешить услугу \"Поделись балансом\"", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_1), QtGui.QApplication.translate("self", "Общее", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_access_groupBox.setToolTip(QtGui.QApplication.translate("self", "Настройки скорости абонентской линии по-умолчанию для абонентов данного тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_access_groupBox.setWhatsThis(QtGui.QApplication.translate("self", "Настройки скорости абонентской линии по-умолчанию для абонентов данного тарифного плана", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_access_groupBox.setTitle(QtGui.QApplication.translate("self", "Настройки скорости по-умолчанию", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_in_label.setText(QtGui.QApplication.translate("self", "IN", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_out_label.setText(QtGui.QApplication.translate("self", "OUT", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_max_label.setText(QtGui.QApplication.translate("self", "MAX", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_min_label.setText(QtGui.QApplication.translate("self", "MIN", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_burst_label.setText(QtGui.QApplication.translate("self", "Burst", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_burst_treshold_label.setText(QtGui.QApplication.translate("self", "Burst Treshold", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_burst_time_label.setText(QtGui.QApplication.translate("self", "Burst Time", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_priority_label.setText(QtGui.QApplication.translate("self", "Приоритет", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setToolTip(QtGui.QApplication.translate("self", "Настройки скорости в зависимости от времени(периода тарификации)", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setWhatsThis(QtGui.QApplication.translate("self", "Настройки скорости в зависимости от времени(периода тарификации)", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("self", "Настройки скорости по времени", None, QtGui.QApplication.UnicodeUTF8))
        self.add_speed_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_speed_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.speed_table.setSortingEnabled(False)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("self", "Настройки скорости", None, QtGui.QApplication.UnicodeUTF8))
        self.trafficcost_label.setText(QtGui.QApplication.translate("self", "Цена за МБ трафика", None, QtGui.QApplication.UnicodeUTF8))
        self.add_traffic_cost_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_traffic_cost_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.prepaid_traffic_cost_label.setText(QtGui.QApplication.translate("self", "Предоплаченный трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.add_prepaid_traffic_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_prepaid_traffic_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.reset_traffic_edit.setText(QtGui.QApplication.translate("self", "Сбрасывать в конце периода предоплаченый трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtGui.QApplication.translate("self", "NetFlow тарификация", None, QtGui.QApplication.UnicodeUTF8))
        self.add_radius_traffic_cost_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_radius_traffic_cost_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_radius_prepaidtraffic.setTitle(QtGui.QApplication.translate("self", "Предоплаченный трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_traffic_prepaid_direction.setText(QtGui.QApplication.translate("self", "Направление", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_traffic_prepaid_volume.setText(QtGui.QApplication.translate("self", "Объём", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_radius_traffic_reset_prepaidtraffic.setText(QtGui.QApplication.translate("self", "Cбрасывать в конце расчётного периода предоплаченный трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_radius_traffic_tarification_settings.setTitle(QtGui.QApplication.translate("self", "Параметры тарификации", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_traffic_direction.setText(QtGui.QApplication.translate("self", "Направление", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_traffic_tarification_step.setText(QtGui.QApplication.translate("self", "Единица тарификации, кб.", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_traffic_rounding.setText(QtGui.QApplication.translate("self", "Способ округления", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_radius_traffic), QtGui.QApplication.translate("self", "Radius трафик", None, QtGui.QApplication.UnicodeUTF8))
        self.add_time_cost_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_time_cost_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_radius_time_prepaid.setTitle(QtGui.QApplication.translate("self", "Предоплаченное время", None, QtGui.QApplication.UnicodeUTF8))
        self.prepaid_time_label.setText(QtGui.QApplication.translate("self", "Предоплачено, с", None, QtGui.QApplication.UnicodeUTF8))
        self.reset_time_checkbox.setText(QtGui.QApplication.translate("self", "Сбрасывать в конце расчётного периода предоплаченное время", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_radius_time_tarification_settings.setTitle(QtGui.QApplication.translate("self", "Параметры тарификации", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_time_rounding.setText(QtGui.QApplication.translate("self", "Способ округления", None, QtGui.QApplication.UnicodeUTF8))
        self.label_radius_time_tarification_step.setText(QtGui.QApplication.translate("self", "Период тарификации, сек.", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_radius_time), QtGui.QApplication.translate("self", "Radius время", None, QtGui.QApplication.UnicodeUTF8))
        self.add_onetime_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_onetime_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), QtGui.QApplication.translate("self", "Разовые услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.del_periodical_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.add_periodical_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), QtGui.QApplication.translate("self", "Периодические услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.add_limit_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_limit_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), QtGui.QApplication.translate("self", "Лимиты", None, QtGui.QApplication.UnicodeUTF8))
        self.add_addonservice_button.setText(QtGui.QApplication.translate("self", "+", None, QtGui.QApplication.UnicodeUTF8))
        self.del_addonservice_button.setText(QtGui.QApplication.translate("self", "-", None, QtGui.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), QtGui.QApplication.translate("self", "Подключаемые услуги", None, QtGui.QApplication.UnicodeUTF8))
        self.toolBar.setWindowTitle(QtGui.QApplication.translate("self", "toolBar", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRefresh.setText(QtGui.QApplication.translate("self", "Обновить", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSave.setText(QtGui.QApplication.translate("self", "Сохранить", None, QtGui.QApplication.UnicodeUTF8))
    ...
    def tabordering(self):
        ...
        self.setTabOrder(self.lineEdit_userblock_cost, self.spinBox_max_block_days)
    ...
    def fixtures(self):
        ...
        if self.model:
            ...
            self.checkBox_userblock_balance_require.setChecked(self.model.userblock_require_balance or False)
    ...
    def accept(self):
        ...
        try:
            ...
            model.userblock_require_balance = self.checkBox_userblock_balance_require.isChecked()
