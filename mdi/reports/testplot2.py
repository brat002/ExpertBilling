...
from bpmplQImage import bpmplQImage as bpQImage_
...
class MainWindow(QtGui.QMainWindow):
    ...
    def createLetter(self, name, address, orderItems, sendOffers):
        ...
        cursor.insertBlock()
        cursor.insertText(str("отжежсука"))

        cursor.setPosition(topFrame.lastPosition())
        #cursor.setPosition(cursor.currentFrame().parentFrame().lastPosition())
        ...
        cursor.insertText(self.tr("Date: %1").arg(date.toString("d MMMM yyyy")))
        cursor.insertBlock()
