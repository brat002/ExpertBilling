...
class MainWindow(QtGui.QMainWindow):
    ...
    def createSample(self):
        ...
        aa = time.clock()
        #editor = self.createLetter("report3_nas.xml", [(17, tm5, tm6, (1,2,3))])
        #editor = self.createLetter("report3_nas_nas.xml", [(2, tm5, tm6)])
        editor = self.createLetter("report3_nass.xml", [((1,2,3), tm5, tm6)])
        #editor = self.createLetter("report3_ttr_nas.xml", [(tm7, tm6, (1,2,3))])
        #editor = self.createLetter("report3_tutr_nas.xml", [(tm7, tm6, (1,2,3))])
        #editor = self.createLetter("report3_tus_nas.xml", [((15, 16, 17, 20, 21, 22), tm1, tm6, (1, 2, 3))])
        
        #editor = self.createLetter("report3_nas.xml", [(17, tm5, tm6), (1,2,3)])
        #editor = self.createLetter("report3_port.xml", [((21, 80, 113), tm1, tm6)])
        ...
        #f.write(tdoc.toHtml())
        #f.close()
        #editor = self.createLetter("report3_pie.xml", [((15, 16, 17), tm1, tm2)])
        #editor = self.createLetter("report3_sess.xml", [((15, 16, 17), tm3, tm4)])
        #editor = self.createLetter("report3_tr.xml", [(tm3, tm6)])
        print time.clock() - aa
